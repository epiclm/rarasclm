...
--
-- Dumping data for table `enfermedad_rara_omin`
--

LOCK TABLES `enfermedad_rara_omin` WRITE;
/*!40000 ALTER TABLE `enfermedad_rara_omin` DISABLE KEYS */;
/*!40000 ALTER TABLE `enfermedad_rara_omin` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-05-17 18:41:14
