...
import es.jclm.cs.rarasclm.form.MessageForm;
...
public class HomeController {
	...
	@RequestMapping(value = "/dosinsert", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/doslist", method = RequestMethod.GET)
