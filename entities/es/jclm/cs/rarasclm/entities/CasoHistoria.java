...
/**
 * CasoHistoria generated by hbm2java
 */
@Entity
@Table(name = "caso_historia", catalog = "rarasclmtest")
public class CasoHistoria implements java.io.Serializable {
	...
	public CasoHistoria(CasoHistoriaId id, String enfrara) {
		this.id = id;
		this.enfrara = enfrara;
	}

	public CasoHistoria(CasoHistoriaId id, Integer paciente, Short numCaso, String enfrara, Short declarada,
	...
	@AttributeOverrides({
			@AttributeOverride(name = "idCaso", column = @Column(name = "id_caso", nullable = false, length = 10)),
			@AttributeOverride(name = "idVersion", column = @Column(name = "id_version", nullable = false)) })
	public CasoHistoriaId getId() {
		return this.id;
	}

	public void setId(CasoHistoriaId id) {
		this.id = id;
	}
